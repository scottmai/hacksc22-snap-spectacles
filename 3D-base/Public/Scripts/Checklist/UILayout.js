// LayoutGroup.js
// Version: 1.0.0
// Description: Creates a grid layout of children elements with specified settings
...
//@ui {"widget":"separator"}
//@input bool additional
//@ui {"widget":"group_start", "label":"Additional Settings", "showIf" : "additional"}
//@input  bool initializeOnStart = true  {"hint" : "Disable if you don't need to initialize it later from another script"}
//@input bool resizeParent  {"hint" : "Enable if you want to resize parent around children"}
//@input bool ignoreDisabled {"hint" : "Ignore disabled objects"}
//@ui {"widget":"group_end"}
...
script.api.updateLayout = updateLayout;
