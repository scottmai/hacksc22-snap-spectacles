...
function translateWordToLang(word, lang){
  ...
  switch(lang){
    case 'Spanish':
      translatedWord = spanish[index];
      break;
    case 'French':
      translatedWord = french[index];
      break;
    case 'Chinese':
      translatedWord = chinese[index];
      break;
    case 'Pinyin':
      translatedWord = pinyin[index];
      break;
  }
...
function setGameMode(){
    print("test response");
    if(script.game!==null && script.learn!==null){
